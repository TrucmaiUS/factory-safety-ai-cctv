...
def start_camera(camera_id: str, max_frames: int | None = Query(default=None, ge=0, le=200000)) -> dict:
    try:
...
def restart_camera(camera_id: str, max_frames: int | None = Query(default=None, ge=0, le=200000)) -> dict:
    try:
...
def activate_camera(camera_id: str, max_frames: int | None = Query(default=None, ge=0, le=200000)) -> dict:
    try:
